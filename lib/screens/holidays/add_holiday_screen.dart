                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text(
                                'Create a holiday entry with title, dates and reason',
                                style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Row(
                              children: [
                                Icon(Icons.edit_calendar_rounded, color: _C.navy, size: 20),
                                SizedBox(width: 8),
                                Text(
                                  'Holiday Details',
                                  style: TextStyle(
                            ...
                            const Text(
                              'Fill the required details below. Existing API and business logic remain unchanged.',
                              style: TextStyle(
                                fontSize: 12,
                                color: _C.textSub,
                                height: 1.5,
